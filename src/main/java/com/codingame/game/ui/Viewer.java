...
public class Viewer {
    ...
    public void drawEmptyBarrier(int i, int j, Constants.Orientation dir){
        ...
        int barrierI = i;
        if (dir.equals(Constants.Orientation.HOR)){barrierI-=1;};
    ...
    public void drawPlayer(int i, int j, int playerId){
        ...
        Sprite player = createSprite(imageName, j * Constants.CELL_SIZE + (j*Constants.BARRIER_SIZE), i * Constants.CELL_SIZE + i*Constants.BARRIER_SIZE, 50, 0);
